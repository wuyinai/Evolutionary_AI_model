  ...
  <div class="sys-user-view">
    <div class="page-header">
      ...
      <div class="header-actions">
        <button v-if="hasPermission('sys:user:add')" class="btn btn-primary" @click="openAddModal">
      ...
      <table class="user-table">
        ...
        <tbody>
          ...
          <tr v-else v-for="user in filteredUsers" :key="user.id">
            ...
            <td class="action-col">
              <button v-if="hasPermission('sys:user:edit')" class="btn-icon" @click="openEditModal(user)" title="编辑">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                </svg>
              </button>
              <button v-if="hasPermission('sys:user:delete')" class="btn-icon btn-danger-icon" @click="handleDelete(user.id)" title="删除">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
